...
class Scene:
    ...
    def load(self):
        ...
        self.main_obj = ColorSphere(app, pos=(-6, 10, 0), rot=(0, 0, 0), color=(0.8, 0.2, 0.2))
        self.main_obj.down_vel = 0
        self.main_obj.side_vel = 0.03
        self.objs.append(self.main_obj)
        add(self.main_obj)
        
        self.main_obj = Fixed_Car(app, pos=(0, 0, 0), rot=(0, 180, 0), color=(0.8, 0.2, 0.2))
        self.main_obj.update()
        add(self.main_obj)

        self.main_obj = ColorPlane(app, pos=(0, 0, 0), rot=(0, 0, 0), uni_scale=10, color=(0.4, 0.4, 0.4), specularity=0.1, metalness=0)
        add(self.main_obj)
